...
export class CustomerReviewComponent implements OnInit {
 ...
 t={bname:"",rate5:0,rate4:0,rate3:0,rate2:0,rate1:0};
  ...
  ngOnInit() {
    ...
    this.http.post("business",{rand:this.rand})
    .subscribe((data)=>{
...

  {
    ...
    this.http.post("rate",{bname:this.business,rate5:this.t.rate5,rate4:this.t.rate4,rate3:this.t.rate3,rate2:this.t.rate2,rate1:this.t.rate1}).subscribe((data)=>{
